...
install_allora_cli() {
    ...
    cd allora-chain
    make all || { echo "Failed to install Allora CLI"; exit 1; }
...
CMD ["python", "your_eth_script.py"]  # Замените на ваш скрипт
EOF
...
COPY . /app
RUN pip install -r requirements.txt
CMD ["python", "your_btc_script.py"]  # Замените на ваш скрипт
EOF
...
COPY . /app
RUN pip install -r requirements.txt
CMD ["python", "your_ada_script.py"]  # Замените на ваш скрипт
EOF
...
COPY . /app
RUN pip install -r requirements.txt
CMD ["python", "your_sol_script.py"]  # Замените на ваш скрипт
EOF
...
COPY . /app
RUN pip install -r requirements.txt
CMD ["python", "your_xrp_script.py"]  # Замените на ваш скрипт
EOF
...
COPY . /app
RUN pip install -r requirements.txt
CMD ["python", "your_ltc_script.py"]  # Замените на ваш скрипт
EOF
}
